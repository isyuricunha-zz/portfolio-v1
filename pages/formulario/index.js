...
const validationSchema = Yup.object({
  fullName: Yup.string()
    .max(50, "Tem certeza que seu nome completo está correto?")
    .required("Nome completo é necessário"),
  email: Yup.string()
    .email("Endereço de e-mail inválido")
    .required("E-mail é necessário")
    .max(50, "Tem certeza que seu e-mail está correto?"),
});
...
export default function Home() {
  ...
  return (
    ...
    <div className="flex h-screen bg-gradient-to-l md:bg-gradient-to-r from-black-900   to-black-700">
              ...
              <Form>
                <div>
                  ...
                  <Field
                    ...
                    className="px-4 py-3 w-full mt-2 border-2 rounded-md text-sm outline-none focus:border-1 focus:border-orange-600 "
                  />
                ...
                <div className="flex flex-col ">
                  ...
                  <textarea
                    ...
                    className="px-4 py-3 w-full border-2 mt-2 rounded-md text-sm outline-none focus:border-1 focus:border-orange-600 "
